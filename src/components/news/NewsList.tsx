...
export const newsArticles = {
  original: [
    { id: 13298, title: "出售优质棋牌游戏源码，助你轻松打造一流游戏平台！", desc: "", image: "/images/news/13298.png", date: "", tag: "top" },
    { id: 13297, title: "我们提供多种类型的游戏开发服务", desc: "", image: "/images/news/13297.png", date: "", tag: "rec" },
    { id: 13292, title: "网狐H5卓越平台海外版重磅上线！", desc: "", image: "/images/news/13292.png", date: "", tag: "hot" },
    ...
    { id: 13334, title: "棋牌出海：东南亚六国热门棋牌游戏解析", desc: "目前，东南亚棋牌市场一些游戏热度极高", image: "/images/news/13334.png", date: "2024/11/14" },
    ...
    { id: 13331, title: "棋牌游戏出海的那些坑，你踩到了吗", desc: "出海的本质就是要克服文化和市场的差异", image: "/images/news/13331.png", date: "2024/10/15" },
    ...
    { id: 13328, title: "购买三无棋牌源码存在哪些隐患？", desc: "开发或运营棋牌平台，建议寻找有合法授权的源码或开发服务。", image: "/images/news/13328.png", date: "2024/09/27" },
    { id: 13327, title: "棋牌出海用户流失的五大常见原因", desc: "棋牌游戏进入海外市场，普遍面临用户接受度低", image: "/images/news/13327.png", date: "2024/09/20" },
  ],
  qpnews: [
    { id: 12960, title: "网狐卓越Creator平台全新上市：做市场认可的创新型棋牌", desc: "", image: "/images/news/12960.jpg", date: "", tag: "top" },
    { id: 13245, title: "『通知』网狐科技中秋节放假通知", desc: "", image: "/images/news/13245.jpg", date: "", tag: "rec" },
    { id: 13153, title: "网狐Rummy上线诚招印度联运合伙人", desc: "", image: "/images/news/13153.png", date: "", tag: "hot" },
    ...
    { id: 13245, title: "『通知』网狐科技中秋节放假通知", desc: "中秋快乐", image: "/images/news/13245.jpg", date: "2021/09/19" },
    { id: 13153, title: "网狐Rummy上线诚招印度联运合伙人", desc: "2020年棋牌行业最火的方向是出海", image: "/images/news/13153.png", date: "2020/08/18" },
    ...
    { id: 13118, title: "热烈庆贺网狐科技乔迁新址", desc: "2020年7月，网狐科技乔迁新址", image: "/images/news/13118.png", date: "2020/07/03" },
    { id: 13101, title: "网狐全新业务模式招募全球合伙人", desc: "2020年已接近过半，对国内的游戏从业者", image: "/images/news/13101.jpg", date: "2020/06/05" },
    { id: 13103, title: "网狐《海王》捕鱼全新上市", desc: "网狐也基本遵循着一年一款精品捕鱼游戏的节奏", image: "/images/news/13103.png", date: "2020/06/10" },
  ],
};
...
export function NewsFeatured({ type }: NewsFeaturedProps) {
  const articles = (newsArticles[type] || []).slice(0, 3);
    ...
    <div className="flex justify-center items-start">
      {articles.map((article, index) => (
        ...
        >
          ...
          <p className="text-center px-[10px] py-[2px] text-[18px] text-black leading-[32px] mt-[2px] overflow-hidden text-ellipsis whitespace-nowrap">
            <Link
              href={`/news/${article.id}`}
...
export function NewsArticles({ type }: NewsArticlesProps) {
  const articles = (newsArticles[type] || []).slice(3);
